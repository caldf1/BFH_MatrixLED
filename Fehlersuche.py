...
Valueset = [
    ...
    [29,2,9,0,0,0,20,19,10,11,28,31,30,39], # OL 29 -> 39
...
g = [[255]*16,[255]*16,[255]*16,[255]*16,[255]*16,
        [255]*16,[255]*16,[255]*16,[255]*16,[255]*16,
        [255]*16,[255]*16,[255]*16,[255]*16,[255]*16,
        [255]*16,[255]*16,[255]*16,[255]*16,[255]*16,] #*20x10 (16)
...
def showPicture():
     ...
     while i < 20:
          ...
          #ls.set_rgb_values(i*10, 10, blue[i], g[i], red[i])
          i += 1
...
changeSinglePixel(187, 255, 0, 0)
changeSinglePixel(178, 255, 0, 0)
...
changeSinglePixel(138, 255, 0, 0)
changeSinglePixel(137, 255, 0, 0)
changeSinglePixel(136, 255, 0, 0)
changeSinglePixel(127, 255, 0, 0)
...
changeSinglePixel(48, 255, 0, 255)
changeSinglePixel(39, 255, 0, 255)
changeSinglePixel(38, 255, 0, 255)
changeSinglePixel(37, 255, 0, 255)
changeSinglePixel(28, 255, 0, 255)
changeSinglePixel(27, 255, 0, 255)
changeSinglePixel(26, 255, 0, 255)
changeSinglePixel(19, 255, 0, 255)
changeSinglePixel(18, 255, 0, 255)
changeSinglePixel(17, 255, 0, 255)
changeSinglePixel(8, 255, 0, 255)
