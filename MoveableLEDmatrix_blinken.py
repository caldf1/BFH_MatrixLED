...
#        self.__cycleY = 0                                                           # für die Bewegung nach oben und unten
        self.__startX = 0 
        self.__startY = 0
        self.__format = imageFormat                                                 # 'normal', 'portrait', 'landscape'
    ...
    def __loadImage__(self): # Werte für StartColumn und numberOfColumn jeweils von 1 bis 20.
        ...
        if self.__move != 'false': # y = (x + 1) %(maxX + 1)
            ...
            if (self.__moveHorizontal != 'false' and self.__format != 'portrait'):
            ...
            # oben-unten-Bewegung
            if self.__moveVertical != 'false' and self.__format != 'landscape':
